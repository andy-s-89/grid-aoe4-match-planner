...
{
    public class Upgrade : QueueableItem
    {
        ...
        public Upgrade(PlacedBuilding parent, UpgradeData data, int queuedTime)
        {
            Parent = parent;
            Data = data;
        ...
        public void AddPictureBox(PictureBox upgradePictureBox)
        {
            ItemPictureBox = upgradePictureBox;
        }

        public void AddUpgradeToDrawingPanel()
        {
            var picBox = myForm.pictureBoxesUpgrades.FirstOrDefault(pBox => pBox.Name == Data.id);
        ...
        {
            myForm.upgradeManager.RemoveUpgrade(this);
